      ...
      res = _tracks?.map((item) => (
        ...
        >
          <div className="item w-full relative">
            ...
            <div className="sub_item w-2/6 absolute bottom-0 right-0 mb-3 mr-3 invisible opacity-0">
              <Image
                layout="responsive"
                height="64"
                width="64"
          ...
          <div className="text-sm font-semibold mt-2 whitespace-nowrap overflow-hidden overflow-ellipsis hover:underline cursor-pointer">
            {item.name}
          </div>
