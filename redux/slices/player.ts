...
// I have made all slices that are used throught in  completeting the project that includes slices for player section also  . So left it as it is not used . It will be used in future .
          // - Ishu pathak 